...
const submissionKafkaTopic = (process.env.SUBMISSION_TOPIC && process.env.SUBMISSION_TOPIC != "OFF") ? process.env.SUBMISSION_TOPIC : "sl-submissions-dev"
