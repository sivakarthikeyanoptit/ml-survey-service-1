...
module.exports = class Programs extends Abstract {
  ...
  */
  ...
  async removeSolutions(req) {
    ...
    /**
  * @api {post} /assessment/api/v1/programs/create Create Program
  * @apiVersion 1.0.0
  * @apiName create
  * @apiGroup Program
  * @apiSampleRequest /assessment/api/v1/programs/create
  ...
  */
  ...
  async create(req) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        return resolve({
          message : messageConstants.apiResponses.PROGRAM_CREATED,
  ...
  /**
  * @api {post} /assessment/api/v1/programs/update/:programId Update Program
  * @apiVersion 1.0.0
  * @apiName Update
  * @apiGroup Program
  * @apiSampleRequest /assessment/api/v1/programs/update/5ff09aa4a43c952a32279234
  * @apiHeader {String} internal-access-token internal access token 
  * @apiHeader {String} X-authenticated-user-token Authenticity token 
  * @apiParamExample {json} Request-Body:
  * {
